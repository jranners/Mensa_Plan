const TRANSLATIONS = {
  de: {
    ...
    updatePrompt: "Ein neues Update für den Mensaplan ist verfügbar. Die App wird aktualisiert, um die neuesten Gerichte und Funktionen zu laden.",
    updateRestart: "App neu starten",
    updateAutoRestart: "Automatischer Neustart in {n}s",
    updateLater: "Später",
    ...
    sectionMeisterwerk: "Meisterwerk",
  ...
  en: {
    ...
    updatePrompt: "A new update for the canteen plan is available. The app will restart to load the latest dishes and features.",
    updateRestart: "Restart app",
    updateAutoRestart: "Restarting automatically in {n}s",
    updateLater: "Later",
